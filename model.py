...
from cluster import cluster_SC, cluster_AHC
...
class Diarizer:
    ...
    def diarize(self,
        ...
        print('Shape: {}'.format(tuple(signal.shape)))
        ...
        print('embedding:  {}'.format(embeds))
        print('embedding:  {}'.format(len(embeds)))
        ...
        print('cluster: {}'.format(len(cluster_labels)))
